...
{
    InformatikosFakultetasManiskis = students.filter(Maniskis => Maniskis.faculty === 'Informatikos fakultetas');
    console.table(InformatikosFakultetasManiskis);
}
console.groupEnd();
...
{
    ChemijosFakultetasManiskis = students.filter(Maniskis => Maniskis.faculty === 'Chemijos fakultetas');
    console.table(ChemijosFakultetasManiskis);
}
console.groupEnd();
...
{
    ElektrosIrElektronikosFakultetasManiskis = students.filter(Maniskis => Maniskis.faculty === 'Elektros ir elektronikos fakultetas');
    console.table(ElektrosIrElektronikosFakultetasManiskis);
}
console.groupEnd();

console.groupCollapsed('4. Atspausdinti tik pirmo kurso studentus');
{
    FirstCourseManiskis = students.filter(Maniskis => Maniskis.course === 1);
    console.table(FirstCourseManiskis);
}
console.groupEnd();

console.groupCollapsed('5. Atspausdinti tik antro kurso studentus');
{
    SecondCourseManiskis = students.filter(Maniskis => Maniskis.course === 2);
    console.table(SecondCourseManiskis);
}
console.groupEnd();

console.groupCollapsed('6. Atspausdinti tik trečio kurso studentus');
{
    ThirdCourseManiskis = students.filter(Maniskis => Maniskis.course === 3);
    console.table(ThirdCourseManiskis);
}
console.groupEnd();

console.groupCollapsed('7. Atspausdinti tik ketvirto kurso studentus');
{
    FourthCourseManiskis = students.filter(Maniskis => Maniskis.course === 4);
    console.table(FourthCourseManiskis);
}
console.groupEnd();
...
console.groupCollapsed('9. Atspausdinti visų Informatikos fakulteto studentų vidurkius');
{
    ...
    const IfspSum = InformatikosFakultetasManiskis.reduce((sum, { marks }) => sum + marks, 0);
    const IfsvAvg = IfspSum / InformatikosFakultetasManiskis.marks.length;
    console.log({ IfsvAvg });
